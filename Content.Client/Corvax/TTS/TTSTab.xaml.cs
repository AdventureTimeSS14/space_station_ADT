...
public sealed partial class TTSTab : Control
{
    ...
    private void BuildCategoryButtons()
    {
        ...
        foreach (var category in _voicesByCategory.Keys.OrderBy(c => c))
        {
            ...
            var localizedCategory = Loc.TryGetString($"tts-voice-category-{category}", out var localized) 
                ? localized 
                : category;
    ...
    private void SelectCategory(string? category)
    {
        ...
        var displayName = category == null 
            ...
            : (Loc.TryGetString($"tts-voice-category-{category}", out var localized) ? localized : category);
        ...
        foreach (var button in buttons)
        {
            ...
            else
            {
                ...
                var btnCategory = _voicesByCategory.Keys.FirstOrDefault(c => 
                    (Loc.TryGetString($"tts-voice-category-{c}", out var loc) ? loc : c) == button.Text);
