...
using Content.Client._DeltaV.NanoChat;
...
public sealed partial class NanoChatUiFragment : BoxContainer
{
    ...
    private void SetupEventHandlers()
    {
        ...
        MuteButton.OnPressed += _ =>
        {
            ...
            UpdateMuteButton();
            ActionSendUiMessage?.Invoke(NanoChatUiMessageType.ToggleMute, null, null, null);
        };
    ...
    private void SendMessage()
    {
        ...
        // Send message event
        ActionSendUiMessage?.Invoke(NanoChatUiMessageType.SendMessage, activeChat, messageContent, null);
