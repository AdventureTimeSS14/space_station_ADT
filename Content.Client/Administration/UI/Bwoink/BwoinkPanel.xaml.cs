...
namespace Content.Client.Administration.UI.Bwoink
{
    ...
    public sealed partial class BwoinkPanel : BoxContainer
    {
        ...
        public int _selectedTypeTagId = 0;
        ...
        public BwoinkPanel(Action<string> messageSender, bool isUserAHelp = false)
        {
            ...
            if (isUserAHelp)
            {
                ...
                {
                    _selectedTypeTagId = type_tag.Id;
                    UpdateOptionButtons();
                };
            }
            else
        ...
        {
            TypeTag.SelectId(_selectedTypeTagId);
        }
        // ADT-Tweak end
        ...
        private void Input_OnTextEntered(LineEdit.LineEditEventArgs args)
        {
            ...
            if (uiController.UIHelper is AdminAHelpUIHandler adminAhelp)
            {
                ...
                _messageSender.Invoke($"[Tag:{_selectedTypeTagId}] {args.Text}");
            }
            // ADT-Tweak end.
        ...
        public void ReceiveLine(SharedBwoinkSystem.BwoinkTextMessage message)
        {
            ...
            if (tagMatch.Success)
            {
                ...
                {
                    LastTagId = tagId;
                    Logger.Info($"Updated LastTagId to {tagId} for user {message.UserId}");
                }
                else
                {
                    Logger.Info($"Invalid tag ID {tagMatch.Groups[1].Value} for user {message.UserId}, text: {message.Text}");
                }
            }
            // ADT-Tweak end.
