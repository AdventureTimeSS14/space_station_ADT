...
public sealed partial class ChannelFilterPopup : Popup
{
    ...
    public event Action<string>? OnNewCustomEmotes; // ADT-Tweak
    ...
    public ChannelFilterPopup()
    {
        ...
        // ADT-Tweak start
        CustomEmotesButton.OnPressed += CustomEmotesEntered;
        CustomEmotesEdit.Placeholder = new Rope.Leaf(Loc.GetString("adt-chatbox-custom-emotes-placeholder"));

        var customEmotes = cfg.GetCVar(ADTCCVars.ChatCustomEmotes);

        if (!string.IsNullOrEmpty(customEmotes))
        {
            UpdateCustomEmotes(customEmotes);
        }
        // ADT-Tweak end
    }
    ...
    // ADT-Tweak start
    public void UpdateCustomEmotes(string customEmotes)
    {
        CustomEmotesEdit.TextRope = new Rope.Leaf(customEmotes);
    }

    private void CustomEmotesEntered(ButtonEventArgs _args)
    {
        OnNewCustomEmotes?.Invoke(Rope.Collapse(CustomEmotesEdit.TextRope));
    }
    // ADT-Tweak end
