...
public sealed partial class LawDisplay : Control
{
    ...
    public LawDisplay(EntityUid uid, SiliconLawData law, HashSet<ProtoId<RadioChannelPrototype>>? radioChannels) // ADT-Tweak
    {
        RobustXamlLoader.Load(this);
        IoCManager.InjectDependencies(this);

        var identifier = law.LawIdentifierOverride ?? law.Order; // ADT-Tweak
