...
//     private void OnAppearanceChange(Entity<StationAiCoreComponent> ent, ref AppearanceChangeEvent args)
//     {
...
//             container.Count == 0)
//         {
//             _sprite.LayerSetSprite(uid, "ai-screen", new SpriteSpecifier.Rsi(new("ADT/Mobs/Silicon/ai-screen.rsi"), "empty"));
//         }
//         else
//         {
...
//                 return;
//             sprite.LayerSetSprite(StationAiCustomVisualState.Key, screen.Icon);
//         }
//     }
// }
