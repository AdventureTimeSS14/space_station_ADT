...
public sealed partial class RoadmapItem : Control
{
    ...
    public RoadmapItemState ItemState
    {
        ...
        set
        {
            ...
            {
                RoadmapItemState.Planned => "ПЛАНИРУЕТСЯ",
                RoadmapItemState.InProgress => "В ПРОГРЕССЕ",
                RoadmapItemState.Partial => "ЧАСТИЧНО РЕАЛИЗОВАНО",
                RoadmapItemState.Complete => "РЕАЛИЗОВАНО",
                _ => string.Empty
            };
