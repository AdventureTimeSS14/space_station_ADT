...
public sealed class FluxBarControl : Control
{
    ...
    public FluxBarControl() : base()
    {
        ...
        _emptyTex = spriteSys.Frame0(new SpriteSpecifier.Texture(new ResPath("/Textures/ADT/Interface/gun-flux-readout-empty.png")));
        _markTex = spriteSys.Frame0(new SpriteSpecifier.Texture(new ResPath("/Textures/ADT/Interface/gun-flux-readout-mark.png")));
        _fillTex = spriteSys.Frame0(new SpriteSpecifier.Texture(new ResPath("/Textures/ADT/Interface/gun-flux-readout-fill.png")));
    }
