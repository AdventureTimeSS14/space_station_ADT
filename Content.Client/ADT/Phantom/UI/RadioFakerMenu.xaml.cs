...
public sealed partial class RadioFakerMenu : FancyWindow
{
    ...
    public RadioFakerMenu()
    {
        ...
        MessageEdit.Placeholder = new Rope.Leaf(Loc.GetString("radio-faker-text-placeholder"));

        SendButton.OnPressed += args => OnSend?.Invoke(_channels[ChannelButton.SelectedId], NameEdit.Text, Rope.Collapse(MessageEdit.TextRope));
    ...
    public void Populate(List<string> channels)
    {
        ...
        for (var i = 0; i < channels.Count; i++)
        {
            ...
            ChannelButton.AddItem(proto.LocalizedName, i);
        }
