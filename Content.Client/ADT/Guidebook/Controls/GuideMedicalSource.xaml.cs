...
namespace Content.Client.ADT.Guidebook.Controls;
...
public sealed partial class GuideMedicalSource : BoxContainer, ISearchableControl
{
    ...
    private void GenerateControl(MedicalRecipeData entry)
    {
        ...
        processingTexture.Texture = GetRsiTexture("/Textures/ADT/Structures/Machines/medical_assembler.rsi", "mediwave-base");
