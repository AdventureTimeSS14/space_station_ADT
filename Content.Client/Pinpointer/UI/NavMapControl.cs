...
public partial class NavMapControl : MapGridControl
{
    ...
    protected readonly Label ZoomLabel = new()
    {
    ...
    protected readonly Button RecenterButton = new()
    {
    ...
    protected readonly CheckBox BeaconsCheckbox = new()
    {
    ...
    protected readonly PanelContainer NavMapTopPanel;
    ...
    protected override void Draw(DrawingHandleScreen handle)
    {
        ...
        // Map re-centering
        RecenterButton.Disabled = DrawRecenter();

        // Update zoom text
        ZoomLabel.Text = Loc.GetString("navmap-zoom", ("value", $"{(DefaultDisplayedRange / WorldRange):0.0}"));
        ...
        // Hollow window outlines (merged across adjacent glass tiles)
    ...
    {
        // Refresh component refs so DataVersion invalidation works even between Draws.
        EntManager.TryGetComponent(MapUid, out _navMap);
        EntManager.TryGetComponent(MapUid, out _physics);
...
// #ADT-Tweak Start - New Monitor: official NavMapControl kept as reference
// using Content.Client.Stylesheets;
// using Content.Client.UserInterface.Controls;
// using Content.Shared.Input;
// using Content.Shared.Pinpointer;
