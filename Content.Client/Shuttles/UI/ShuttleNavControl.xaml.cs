...
using Content.Client.ADT._Mono.Radar; /// ADT ShipBattle
using Content.Shared.ADT._Mono.Radar; /// ADT ShipBattle
...
public sealed partial class ShuttleNavControl : BaseShuttleControl
{
    ...
    private readonly RadarBlipsSystem _blips; /// ADT ShipBattle
    ...
    protected override void KeyBindDown(GUIBoundKeyEventArgs args) /// ADT ShipBattle
    {
