using Content.Shared._VG.Xenobiology.XenobiologyBountyConsole;
using Content.Shared.Cargo.Components; // <-- ДОБАВЬ ЭТО для BountyFulfillMessage и BountySkipMessage
using JetBrains.Annotations;
using Robust.Client.UserInterface;

namespace Content.Client._VG.Xenobiology.XenobiologyBountyConsole;
