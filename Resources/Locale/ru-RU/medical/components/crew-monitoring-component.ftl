...
# #ADT-Tweak Start - New Monitor: en-style UI key aliases
...
crew-monitoring-ui-scan-waiting = Ожидание ответа сервера...
crew-monitoring-ui-select-server-label = Выберите сервер
crew-monitoring-tab-sensors = Датчики
crew-monitoring-tab-servers = Сервера
...
crew-monitoring-header-server-address = Адрес сервера:
...
crew-monitoring-server-active = Активен
...
# #ADT-Tweak Start - New Monitor: shared UI label keys
...
crew-monitoring-ui-flavor-left-label = В случае экстренной ситуации немедленно свяжитесь с медицинским персоналом станции
crew-monitoring-ui-flavor-right-label = v1.8
# #ADT-Tweak End
