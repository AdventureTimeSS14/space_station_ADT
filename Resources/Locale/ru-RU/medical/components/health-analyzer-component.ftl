...
health-analyzer-window-entity-fluid-level-text = Уровень жидкости:
health-analyzer-window-entity-fluid-loss-text = Потеря жидкости
...
health-analyzer-verb-scan = Просканировать
