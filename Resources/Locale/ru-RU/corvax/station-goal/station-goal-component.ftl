...
station-goal-delta-ambusol =
    ...
    Вам необходимо полностью восстановить электропитание, атмосферу, привести внешний вид к изначальному состоянию. После этого в стерильных условиях вирусологии провести синтезацию 500u (пятисот единиц) амбузола, для этого Вам предоставлена 1 (одна) бутылочка ромерола.
