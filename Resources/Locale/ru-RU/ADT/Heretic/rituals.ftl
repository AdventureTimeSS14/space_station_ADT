...
heretic-ritual-basic-heart-desc = Возьмите с собой одно сердце, ручку и бумагу, чтобы сбросить ваши цели жертвоприношений. Будьте внимательны, ведь вы можете сбросить те же цели, что и раньше. Используйте это только в случае крайней необходимости.
...
heretic-ritual-side-armor-desc = Создssаёт уникальную робу и капюшон в зависимости от пути еретика. Путь Клинка — робу клинка, путь Плоти — робу плоти, и т.д.
