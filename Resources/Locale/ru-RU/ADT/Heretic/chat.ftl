...
blade-arena-crit-message = Мансус доволен вашим выступлением, теперь можете уйти.
blade-arena-crit-message-heretic = Вы хорошо справились, теперь можете уйти.
...
influence-gain-message-8 =
    ЖИЗНЬ БЫСТРОТЕЧНА,
    НО ЧТО ЖЕ ВСЁ-ТАКИ ОСТАЕТСЯ?
influence-gain-message-9 =
    КРОВАВЫЙ ДОЖДЬ.
    ЦАРСТВО КРОВИ.
influence-gain-message-10 =
    МОЩЬ...
    БЕСПРИМЕРНАЯ. НЕЕСТЕСТВЕННАЯ.
influence-gain-message-11 =
    ВРАТА МАНСУСА
    ОНИ ЗДЕСЬ, ОНИ ОТКРЫТЫ.
...
influence-gain-message-14 =
    ИХ РУКА НА МОЕМ БОКУ.
influence-gain-message-15 =
    ОНИ ХОДЯТ ПО МИРУ.
    НЕЗАМЕЧЕНЫ.
influence-gain-message-16 =
    ХОДЬБА МЕЖДУ ПЛОСКОСТЯМИ.

fracture-examine-message-1 =
    Неужели наша реальность так хрупка?
...
fracture-examine-message-5 =
    Я чувствую руку на своём горле.
fracture-examine-message-6 =
    Я плачу, но слезинки не падают.
...
fracture-examine-message-12 =
    Неужели это то, что мы есть?
    Это то, чем мы можем быть?
