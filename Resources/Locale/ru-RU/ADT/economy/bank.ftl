...
bank-deposit = Пополнение
bank-withdrawal = Снятие
bank-system = Система
bank-program-ui-transaction-history = История операций
bank-program-ui-transfer-money = Перевести деньги
bank-program-ui-transfer-title = Перевод денег
bank-program-ui-target-account = Номер счёта получателя
