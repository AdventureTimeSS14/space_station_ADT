...
xeno-vacuum-clear-popup = Вы выпустили {$ent}!
xeno-vacuum-suction-succeed-popup = Вы вакуумируете {$ent}!

xeno-vacuum-suction-fail-no-tank-popup = Вы не имеете связанного хранилища!
xeno-vacuum-suction-fail-invalid-entity-popup = Вы не можете вакуумировать {$ent}!
