...
stasis-bed-inaprovaline = [color=#6DFFA5]Пациент стабилизируется инапровалином.[/color]
...
cryo-pod-window-metabolism-text = Усвоение
cryo-pod-window-metabolism-value = ×{$speedup}
