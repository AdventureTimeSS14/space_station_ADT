...
flavor-complex-adtgummydrask = как ежевичный сироп. Попробовав кусочек, язык будто леденеет.
...
flavor-complex-adtgummyvox = как лимонный сок. Вам кажется вкус не сочетается с цветом желе, может так и задуманно?
