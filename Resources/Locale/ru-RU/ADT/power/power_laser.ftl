...
ptl-enabled = включен
ptl-disabled = выключен

ent-MachinePowerTransmissionLaser = Лазерный передатчик энергии
    .desc = Пересылает энергию через лазерный луч в обработчики энерги. Просто вставьте его в сеть и приходите завтра за пачкой кредитов (если энергия есть в сети). Так же не вставайте на пути у лазера.