...
reagent-desc-cursed-blood = Фиолетовая, быстроиспаряющаяся жидкость с едким трупным запахом.

reagent-name-alien-blood-plus = инопланетная кровь+
reagent-desc-alien-blood-plus = Странная инопланетная кровь, которую можно пить с некоторыми последствиями.
