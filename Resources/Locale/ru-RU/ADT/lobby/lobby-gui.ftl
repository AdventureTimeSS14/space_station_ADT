...
ui-lobby-sponsor-button-main-level = Уровень спонсорства: нет :((
ui-lobby-sponsor-button-level = Уровень спонсорства: { $sponsorTier }
...
ui-lobby-sponsor-status = Информация о вашем статусе спонсора
ui-lobby-sponsor-get-sponsor = Стать спонсором
...
ui-sponsor-info-priority = [color=yellow]Приоритетный вход:[/color] { $priority }
ui-sponsor-info-allow-job = [color=yellow]Игнор времени ролей:[/color] { $allowJob }
ui-sponsor-info-separator = [color=gray]────────────────────────[/color]
ui-sponsor-info-expire-date = [color=yellow]Дата окончания:[/color] { $date }
ui-sponsor-info-tier-none = [color=yellow]Уровень спонсорства:[/color] Нет доступа
