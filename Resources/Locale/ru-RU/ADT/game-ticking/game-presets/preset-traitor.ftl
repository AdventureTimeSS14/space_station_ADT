...
dynamic-hard-title = Динамика высокая
dynamic-hard-description = Благодарим за участие в программе Frontier! У нас нету данных про угрозы в вашем секторе, потому будьте на готове!

dynamic-medium-title = Динамика средняя
dynamic-medium-description = Ваша станция в довольно далёком секторе. Вероятность крупных угроз не слишком велика, но и не нулевая.

dynamic-low-title = Динамика низкая
dynamic-low-description = Обжитый, безопасный, близкий сектор. Угрозы есть, однако они далеко на самые крупные.
