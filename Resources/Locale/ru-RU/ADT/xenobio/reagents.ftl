xenobio-reagent-slime-toxin-name = Токсин слизи
xenobio-reagent-slime-toxin-desc = Токсин, который слизь вводит в кровь жертвы во время охоты, поддерживает её в критическом состоянии даже при нулевом объёме крови. Также обладает галлюциногенным и седативным эффектами.
slime-toxin-effect-yawn = Вас внезапно одолевает желание зевнуть.
...
xenobio-reagent-jelly-black-name = слаймочилл
xenobio-reagent-jelly-black-desc = Это желе делает любого потребителя устойчивым к высоким температурам на немалое время. Шахтёры особенно оценят, так как оно защищает от пепельных бурь.
