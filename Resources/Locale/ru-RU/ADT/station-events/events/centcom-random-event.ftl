centcom-random-event-sender = от Центрального Командования

centcom-random-event-announcement = Сообщаем экипажу, что согласно новому регламенту корпоративного закона, { $sighting }

centcom-random-event-sighting-1 = любая алкогольная продукция приравнивается к наркотическим веществам и наказывается соответствующими статьями 103 и 203. Всему экипажу сдать всю алкогольную продукцию службе безопасности.
...
centcom-random-event-sighting-3 = запрещено использовать { $generator } для получения электроэнергии, так как отдел по технике безопасности признал данный источник энергии крайне опасным. Нарушение данного закона приравнивается к нарушению статьи 410.
...
centcom-random-event-doc = ⠀[color=#1b487e]███░███░░░░██░░░░[/color]
    ...
    ⠀[color=#1b487e]░░░░██░░░████░███[/color]
    =============================================
            ОБНОВЛЕНИЕ КОРПОРАТИВНОГО ЗАКОНА
    =============================================
    Дата: $time$
