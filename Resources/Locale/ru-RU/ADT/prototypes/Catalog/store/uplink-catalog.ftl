...
uplink-blood-pump-implant-desc = Субдермальный имплант с резервуаром медикаментов. По команде вводит смесь фаланксимина, кровоостанавливающей пудры и физраствора в кровоток. 3 заряда, работает в критическом состоянии.

uplink-stimulant-implant-name = Cybersun "Стимулятор дезоксиэфедрина"
uplink-stimulant-implant-desc = Субдермальный микроинъектор с запасом дезоксиэфедрина на 3 дозы. Мгновенно вбрасывает стимулятор в кровоток, повышая боевую эффективность носителя.
