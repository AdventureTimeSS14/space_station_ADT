...
uplink-syndihypo-name = Продвинутый инъектор
uplink-syndihypo-desc = Безупречный, стильный, высококачественный инъектор. Позволяет быстрее вводить препарат, обладая немного большей емкостью.
