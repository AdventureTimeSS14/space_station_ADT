...
uplink-contortionist-jumpsuit-desc = Выглядит как костюм атмос-техника, чем и является. Этот комбинезон позволяет носителю скользить через вентиляции. Убедитесь, что на вас нету сумки или скафандра, а так же, что ваши руки свободны.

# Goobstation
uplink-contortionist-jumpsuit-advanced-name = Блюспейс костюм акробата
uplink-contortionist-jumpsuit-advanced-desc = Атмосферный комбинезон, что позволяет вам ползать через вентиляции даже с рюкзаком и скафарбром, использует блюспейс технологии.