...
uplink-syndihypo-name = Гипоспрей Горлекс
uplink-syndihypo-desc = Стерильный инъектор для быстрого введения препаратов. Скопирован с образцов Nanotrasen, Cybersun производит его небольшими партиями для санитаров Мародёров Горлекс.
