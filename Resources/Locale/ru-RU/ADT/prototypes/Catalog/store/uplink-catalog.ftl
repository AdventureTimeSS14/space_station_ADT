...
uplink-MachineGun-magazine-name = Магазин для пистолета-пулемета (.35 авто)
uplink-MachineGun-magazine-desc = Магазин с патронами калибра .35 авто, совместим с пистолетом-пулеметом C-20r
uplink-LightRifle-magazine-name = Магазин для штурмовой винтовки (.20 винтовочный)
uplink-LightRifle-magazine-desc = Магазин с патронами калибра .20 винтовочный, совместим со штурмовыми винтовками "Лектер" и xC-67
...
uplink-nukiesShield-name = двухручный штурмовый щит
uplink-nukiesShield-desc = Массивный и опасный, двухручный щит из элитных материалов для лучшей защиты щитоносца, имеет несколько рядов пластин защищающих от каждого типа урона, а также несколько острейших шипов на основе щита. Да прибудут с вами силы синдиката.

uplink-omnizinpizza-name = коробка с пиццей синдиката
uplink-omnizinpizza-desc = Это самая обычная коробка, с самой обычной пиццей внутри, это именно то, что используют элитные агенты для перекуса между стрельбой с капитаном, и кражей Иана.
