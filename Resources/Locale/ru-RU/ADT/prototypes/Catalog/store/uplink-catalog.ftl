...
uplink-omnizinpizza-desc = Это коробка с самой обычной пиццей внутри. Именно то, что используют элитные агенты Синдиката для перекуса между стрельбой с Капитаном и кражей Иана.
