...
uplink-pinpointer-universal = Универсальный пинпоинтер
uplink-pinpointer-universal-desc = Портативное устройство слежения, способное отслеживать любой физический объект в выключенном состоянии. Держите вертикально для сохранения точности.
