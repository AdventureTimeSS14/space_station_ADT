...
uplink-mod-modules-name = Набор оружейных модулей
uplink-mod-modules-description = Комплект из вертикальной рукояти, лазерного целеуказателя, коллиматорного и оптического прицелов.
