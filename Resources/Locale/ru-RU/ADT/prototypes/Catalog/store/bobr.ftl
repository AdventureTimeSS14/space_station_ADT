...
boobr-c4-name = C-4
boobr-c4-desc = Используйте её, чтобы разрушать стены и шлюзы. Её можно прикрепить практически к любому объекту, а таймер можно изменять. Минимальное значение - 10 секунд.
...
boobr-clean-grenade-desc = После кровавых побоищ незаменимы.
...
boobr-combat-knife-desc = Используйте как хотите: можете закрепить на подствольнике или носить с собой.
bober-melee-weapon-case-name = Набор для ближнего боя
bober-melee-weapon-case-desc = Подходит для всего отряда, включает в себя по 5 шипованных дубинок и мануалов CQC.
