...
boobr-ar12-desc = Продвинутая штурмовая винтовка подогнанная специально под быстрое уничтожение противника. Использует патроны калибра 6.5 мм ТСФ, входящие в набор.
...
boobr-portable-recharger-name = переносной перезарядник
boobr-portable-recharger-desc = Переносной зарядник выделенный для своевременной зарядки в условиях боевых действий.
