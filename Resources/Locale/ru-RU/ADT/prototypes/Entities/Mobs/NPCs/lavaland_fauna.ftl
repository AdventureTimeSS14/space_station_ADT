ent-ADTMobGutlunch = гутлунч
    .desc = Падальщик, питающийся сырым мясом. Часто встречается рядом с пеплоходцами. Даёт густое, целебно-питательное молоко.
ent-ADTMobGubbuck = габбак
    .desc = { ent-ADTMobGutlunch.desc }
ent-ADTMobGuthen = гутхен
    .desc = { ent-ADTMobGutlunch.desc }
...
adt-bullet-deflected = Выстрел отскакивает от туши { $creature }!
