...
ent-ADTPosterPangaariBirthday = С днем рождения, Пангари!
...
ent-ADTPosterLegitGoobLokoAdvertisement = 14 Реклама Локо
    .desc = Рекламный плакат напитка «14 Loko»... Глядя на него, вы внезапно чувствуете жажду, вспоминая удлинённое название напитка, но сразу же передумываете.
