...
ent-ADTClothingHeadHatsCorrectionsOfficerCapGrey = серая фуражка надзирателя СБ
    .desc = Серая фуражка надзирателя Службы Безопасности, само её нахождение в ваших руках, говорит либо о том, что вы очень опытный Надзиратель СБ, либо являетесь кем-то более опытным в бою, чем он сам.
