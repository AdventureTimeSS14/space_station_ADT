...
ent-ADTClothingModsuitBackSMO = МОД "Гиппократ"
...
ent-ADTClothingModsuitBackBrigmedic = МОД "Ангел Хранитель"
    .desc = Более защищенная версия костюма от DeForest Medical Corporation, произведенная специально для полевых врачей. К сожалению крылья слишком маленькие для полета.
...
ent-ADTClothingHeadHelmetModsuitSMO = шлем МОДа "Гиппократ"
...
ent-ADTClothingOuterModsuitBodySMO = оболочка МОДа "Гиппократ"
...
ent-ADTClothingModsuitShoesSMO = ботинки МОДа "Гиппократ"
...
ent-ADTClothingHandsModsuitSMO = перчатки МОДа "Гиппократ"
