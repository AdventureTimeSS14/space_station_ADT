...
ent-ADTClothingEyesWeldingOldStyle = сварочные очки старого образца
    .desc = Устаревшая версия сварочных очков, выпускавшаяся на производстве, которое позже переключилось на мезонные сканеры. Старая школа инженерии.
