...
ent-ADTClothingOuterHardsuitCybersunCrysis = скафандр суперсолдата Cybersun
    .desc = Самая передовая, секретная технология Cybersun в сфере защиты. Кажется, эта разработка ведёт к созданию суперсолдат. Пахнет пластитаном и бесчестным боем.
    .suffix = { "" }
