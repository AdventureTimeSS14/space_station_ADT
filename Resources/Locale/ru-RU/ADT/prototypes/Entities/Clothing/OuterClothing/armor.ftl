...
ent-ADTClothingOuterArmorMinerReiforced = пластинчатый костюм исследователя
...
ent-ADTSewingSelfmadearmorkit = самодельный комплект брони
    .desc = Это всего лишь несколько листов стали, закреплённые на удобных зажимах

ent-IncompleteArmorKit = заготовка самодельного комплект брони
