...
ent-ADTClothingOuterCoatCrazyScientist = Халат безумного учёного 
    .desc = Безумие — это всегда делать одно и то же, ожидая другого результата. И я приму это безумие всем сердцем!


ent-IncompleteCrazyScientist = заготовка халата безумного учёного
