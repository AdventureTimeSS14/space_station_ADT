...
ent-ADTClothingOuterCoatSecurity = пальто службы безопасности
    .desc = Плотное лёгкобронированное пальто Службы Безопасности, из-за своей дороговизны в производстве производится в малых партиях.

ent-ADTClothingOuterCoatCorrectionsOfficerGrey = серое пальто надзирателя СБ
    .desc = Серое плотное лёгкобронированное пальто Надзирателя Службы Безопасности, показывающее его опытный статус всех заключённых, которых он закидывает в камеру. Одним своим видом она говорит, пытаться сбежать - Бесполезно.
