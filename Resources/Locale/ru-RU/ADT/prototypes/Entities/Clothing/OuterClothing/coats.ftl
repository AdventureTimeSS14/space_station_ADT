...
ent-ADTClothingOuterCoatCorrectionsOfficerGrey = серое пальто надзирателя СБ
    .desc = Серое плотное лёгкобронированное пальто Надзирателя Службы Безопасности, показывающее его опытный статус всем заключённым. Одним своим видом она говорит, пытаться сбежать - бесполезно.
