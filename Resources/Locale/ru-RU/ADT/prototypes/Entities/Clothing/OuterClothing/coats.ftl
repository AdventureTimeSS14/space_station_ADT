...
ent-ADTOuterClothingCoatsCrazyScientist = халат безумного учёного
...
ent-ADTClothingOuterCoatLeathOvercoat = кожаный плащ
    .desc = Прочный плащ из грубой кожи.

ent-ADTClothingOuterCoatLeathOvercoatOpened = кожаный плащ
    .desc = Прочный плащ из грубой кожи.
    .suffix = {"Раскрытый"}
...
ent-ADTClothingOuterWinterCoatDetective = зимнее пальто детектива
    .desc = Красивое зимнее пальто детектива в стандартной расцветке. Изготовлено в малых партиях из-за сложности и дороговизны производства.

ent-ADTClothingOuterWinterCoatDetectiveNoir = нуарное зимнее пальто детектива
    .desc = Красивое зимнее пальто детектива в нуарной расцветке. Изготовлено в малых партиях из-за сложности и дороговизны производства.
