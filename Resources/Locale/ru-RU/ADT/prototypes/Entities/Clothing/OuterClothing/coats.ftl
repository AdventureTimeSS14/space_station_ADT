...
ent-ADTClothingOuterCoatSecurity = пальто службы безопасности
    .desc = Плотное легкобронированное пальто Службы Безопасности. Из-за своей дороговизны в производстве изготавливается в малых партиях.

ent-ADTClothingOuterCoatCorrectionsOfficerGrey = серое пальто надзирателя СБ
    .desc = Серое плотное легкобронированное пальто надзирателя Службы Безопасности, демонстрирующее его опыт всем заключённым. Одним своим видом оно говорит: «Пытаться сбежать бесполезно».
...
ent-ADTClothingOuterCoatBrigmedicWB = ветровка Бригмедика
    .desc = Надежная ветровка врача брига. Защитит от любого космического ветра.
