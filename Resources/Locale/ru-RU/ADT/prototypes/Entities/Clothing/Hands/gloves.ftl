...
# Тактические перчатки горничной (без изоляции)
ent-ClothingHandsTacticalMaidGlovesNoInsulated = тактические перчатки горничной
    .desc = Тактические перчатки для горничных — каждая уважающая себя горничная должна уметь незаметно устранять свои цели. К сожалению, проводят электричество.
    .suffix = Проводят электричество
