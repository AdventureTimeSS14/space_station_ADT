...
ent-ClothingEldritchMedalion = зловещий медальон
    .desc = Странный медальон. Стоит вглядеться в его кристаллическую поверхность, и окружающий мир растает, обнажив ваше собственное бьющееся сердце и пульсацию тысяч других.
