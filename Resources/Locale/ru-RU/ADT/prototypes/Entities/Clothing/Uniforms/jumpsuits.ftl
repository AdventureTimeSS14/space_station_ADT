...
ent-ADTClothingGreyUniformGuardOfficer = серый комбинезон заслуженного надзирателя
    .desc = Обновленная серая форма тюремного охранника для сотрудников с опытом работы, украшенная черными полосками на рукавах, символизирующая годы службы и опыт.
