...
ent-ADTClothingUniformsJumpsuitWhiteHoodie = белая толстовка
    .desc = Обычная, комфортная белая толстовка, она тёплая, и вам этого достаточно

ent-IncompleteHoodie = заготовка белой толстовки
...
ent-ADTClothingUniformsJumpsuitDarkShirt = тёмная футболка
    .desc = Обычная футболка, каких ещё довольно много в разнообразных местах.

ent-IncompleteShirt = заготовка тёмной футболки
    .desc = Это всего лишь заготовка, чтобы её закончить нужно использовать иглу на аэтом предмете, или же, использовать ножницы для шитья чтобы разобрать эту заготовку обратно

ent-ADTClothingUniformsJumpsuitGreenSweater = зелёный свитер
    .desc = Тёплый и приятный на ощупь.

ent-IncompleteSweater = заготовка зелёного свитера
    .desc = Это всего лишь заготовка, чтобы её закончить нужно использовать иглу на аэтом предмете, или же, использовать ножницы для шитья чтобы разобрать эту заготовку обратно
