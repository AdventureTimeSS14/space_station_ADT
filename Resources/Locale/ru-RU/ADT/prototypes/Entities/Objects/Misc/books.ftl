...
ent-ADTBookSpaceLaw = Корпоративный закон
...
ent-ADTBookAtmosSupermatter = Руководство Ньютона по атмосу: Суперматерия
...
ent-BookMachineParts = Искусство компромисса
    .desc = Официальное руководство NanoTrasen по модульным машинным компонентам. Каждая страница напоминает, что бесплатных обедов не существует.
