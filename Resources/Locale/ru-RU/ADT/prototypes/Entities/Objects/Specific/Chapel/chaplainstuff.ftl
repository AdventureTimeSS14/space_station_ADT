ent-ADTPhilosopherstone = философский камень
...
grant-language-success = Вы выучили новый язык: {$languages}.
grant-languages-success = Вы выучили новые языки: {$languages}.
