...
ent-ADTStypticPowderChemistryBottle = бутылочка кровоостанавливающей пудры
...
ent-ADTSilverSulfadiazineChemistryBottle = бутылочка сульфадиазина серебра
    .desc = Бутылочка с сульфадиазином серебра, он оказывает успокаивающий эффект на обожённую кожу и медленно заживляет физические травмы.

ent-ADTVialBluespaceBulletWound = блюспейс-пробирка (от пулевых)
    .desc = Блюспейс-пробирка со смесью пунктураза, транексамовой кислоты и олигомеров. Колоть не более 20 единиц смеси за раз.

ent-ADTVialBluespaceMechanicalWound = блюспейс-пробирка (от механических)
    .desc = Блюспейс-пробирка со смесью бикаридина, транексамовой кислоты и олигомеров. Колоть не более 20 единиц смеси за раз.

ent-ADTVialBluespaceBurnedWound = блюспейс-пробирка (от ожогов)
    .desc = Блюспейс-пробирка со смесью дермалина и пиразина. Колоть не более 20 единиц смеси за раз.

ent-ADTVialBluespaceBloodloss = блюспейс-пробирка (от кровопотери и удушья)
    .desc = Блюспейс-пробирка со смесью физраствора и дексалина плюс.

ent-ADTVialBluespaceRadiation = блюспейс-пробирка (от радиации)
    .desc = Блюспейс-пробирка со смесью аритразина и бикаридина.

ent-ADTVialBluespacePoison = блюспейс-пробирка (от ядов)
    .desc = Блюспейс-пробирка со смесью диловена и сидерлака.
