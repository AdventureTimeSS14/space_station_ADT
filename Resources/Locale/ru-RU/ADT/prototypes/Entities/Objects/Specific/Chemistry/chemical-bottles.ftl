...
ent-ADTStypticPowderChemistryBottle = бутылочка кровоостанавливающий пудры
    .desc = Бутылочка с кровоостанавливающей пудрой, она оказывает кровоостанавливающий эффект и медленно заживляет механические травмы.

ent-ADTSilverSulfadiazineChemistryBottle = бутылочка сульфадиазина серебра
    .desc = Бутылочка с сульфадиазином серебра, он оказывает успокаивающий эффект на обожжоную кожу и медленно заживляет физические травмы.
