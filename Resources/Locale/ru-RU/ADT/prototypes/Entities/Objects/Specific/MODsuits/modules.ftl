...
ent-ADTModsuitModNightVisionAdvanced = модуль продвинутого ночного зрения
    .desc = В визор костюма вмонтирован ПНВ дисплей. От обычной модели отличается меньшим энергопотреблением и более качественным изображением.

ent-ADTModsuitModStun = модуль оглушения
    .desc = Позволяет оглушать врагов ударами кулаков, но, к сожалению, фиксирует руки в форме кулаков при использовании, из-за чего несовместимо с приемами боевых искусств, заточенными на удары.
...
ent-ADTModsuitModStorageSyndie = модуль хранилища синдиката
    .desc = Работает так же, как и простой модуль, но делает это намного лучше благодаря манипуляциям с редспейсом.
...
ent-ADTModsuitModReagentScanner = модуль сканера реагентов
    .desc = Проецирует на визор шлема химический анализ - позволяет определить содержимое ёмкостей.

ent-ADTModsuitModStatusReadout = модуль медицинского визора
    .desc = В визор костюма вмонтирован головной дисплей, считывающий и отображающий жизненные показатели всех, кто находится в поле зрения.

ent-ADTModsuitModHealthAnalyzer = модуль анализатора здоровья
    .desc = Миниатюрный сканер тела, встроенный в перчатки костюма - позволяет считать показатели пациента прикосновением.

ent-ADTModsuitModDefibrillator = модуль дефибриллятора
    .desc = Миниатюрный дефибриллятор, встроенный в перчатки костюма - позволяет реанимировать находящихся в состоянии клинической смерти прикосновением.

ent-ADTModsuitModGPS = модуль GPS
    .desc = Встроенный маячок позиционирования. Показывает координаты владельца при осмотре костюма.

ent-ADTModsuitModAnomalyScanner = модуль аномалистического сканера
    .desc = Миниатюрный сканер аномалий, встроенный в перчатки костюма - позволяет анализировать аномальные объекты прикосновением.

ent-ADTModsuitModStorageBluespace = модуль бс-хранилища
    .desc = Хранилище на основе редспейс-сжатия, устанавливаемое исключительно на костюмы Центрального Командования.

ent-ADTModsuitModDiagnosticVisor = модуль диагностического визора
    .desc = В визор костюма вмонтирован головной дисплей, способный анализировать целостность и состояние роботов и экзокостюмов.

ent-ADTModsuitModMesonVision = модуль мезонного визора
    .desc = В визор костюма вмонтирован мезонный сканер, проецирующий структуру станции прямо на дисплей - позволяет видеть различные конструкции.

ent-ADTModsuitModBodycam = модуль камеры
    .desc = Встроенная в шлем костюма камера наблюдения. Транслирует всё происходящее вокруг носителя в камерную сеть службы безопасности.
