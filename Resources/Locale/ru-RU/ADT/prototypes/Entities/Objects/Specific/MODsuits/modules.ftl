...
ent-ADTModsuitModStorageHolding = модуль блюспейс хранилища
    .desc = Локализованный блюспейс карман, теперь в вашем МОД-е. Кажется, что он намного больше, чем обычный модуль хранения.
