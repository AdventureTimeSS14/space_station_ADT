...
ent-ADTPillPack = пачка таблеток
    .desc = упаковка для удобного хранения таблеток
ent-ADTPillCanister = баночка таблеток
...
ent-ADTEthyloxyephedrinePack = упаковка этилоксиэфедрина
    .desc = Слегка нестабильный препарат, помогающий пациентам с приступами внезапного засыпания. Обладает бодрящим эффектом. Существует более эффективный препарат, производный от этого, но по неназванной причине его производство так и не было налажено.