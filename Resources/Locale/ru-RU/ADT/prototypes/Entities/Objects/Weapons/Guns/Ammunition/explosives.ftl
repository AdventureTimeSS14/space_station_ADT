...
ent-ADTCartridgeBlastRocket = разрывной снаряд PG-7VL
    .desc = Гранатомётная боеголовка калибра 93 мм, предназначенная для гранатомета РПГ-7. Более эффективна для уничтожения укрытий.

ent-ADTCartridgeFragRocket = осколочный снаряд OG-7B
    .desc = Гранатомётная боеголовка калибра 40 мм, предназначенная для гранатомета РПГ-7. Более эффективна для уничтожения пехоты.
