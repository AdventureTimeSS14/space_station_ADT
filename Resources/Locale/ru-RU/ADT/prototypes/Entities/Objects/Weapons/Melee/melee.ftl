...
ent-ADTLightbaton = фонарик-дубинка
    .desc = Тяжёлый и увесистый фонарик-дубинка, идеально подходящий как и для хорошего удара по спине заключённого на утреннем обходе, так и для того чтобы слепить по ночам спящих заключённых в камерах перед избиением.
