...
ent-ADTStudentPDA = КПК студента
    .desc = Приехали ли вы изучать космическую архитектуру, невероятно горячие камеры сгорания, псионику или просто на каникулы - теперь вы настоящий космический студент.
