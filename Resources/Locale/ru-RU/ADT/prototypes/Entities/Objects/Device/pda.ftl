...
ent-ADTGardenerPDA = КПК садовода
    .desc = Почему я выростил сотню смерто-крапивы? Потому-что я БЕЗУМНЫЙ!!!
...
ent-ADTFieldDoctorPDA = КПК полевого врача
    .desc = Война... Война никогда не меняеться...

ent-ADTDoctorPDA = КПК доктора
    .desc = Слово ром и слово смерть для вас означает одно и тоже!
