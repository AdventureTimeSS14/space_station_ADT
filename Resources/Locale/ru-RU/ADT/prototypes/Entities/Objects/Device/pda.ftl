...
ent-ADTConcertmasterPDA = КПК концертмейстера
    .desc = КПК концертмейстера. Чтобы делать концерты, наверное.

ent-ADTComposerPDA = КПК композитора
    .desc = Композитор сочинит симфонию? Превратит кусок бумаги в шедевр искусства?

ent-ADTBardPDA = КПК барда
    .desc = Если бренчание на лютне это предел ваших возможностей.
...
ent-ADTKaratekaPDA = КПК каратиста
    .desc = КПК спортсмена, занимающимся каратэ.

ent-ADTKickboxerPDA = КПК кикбоксера
    .desc = КПК спортсмена, занимающимся кикбоксингом.

ent-ADTSavatistPDA = КПК саватиста
    .desc = КПК спортсмена, занимающимся французским боевым искусством, Саватом.

ent-ADTHandToHandCombatMasterPDA = КПК мастера рукопашного боя
    .desc = КПК спортсмена, обладающим высокими навыками владения приёмами рукопашного боя.
...
ent-ADTJudoistPDA = КПК дзюдоиста
    .desc = КПК спортсмена, занимающимся дзюдо.

ent-ADTCoachPDA = КПК тренера
    .desc = КПК спортсмена, посвятившего себя обучению других бойцов.

ent-ADTGladiatorPDA = КПК гладиатора
    .desc = КПК спортсмена, занимающимся гладиаторскими боями.
