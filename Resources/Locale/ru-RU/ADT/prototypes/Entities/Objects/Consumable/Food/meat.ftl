...
ent-ADTFoodMeatSmokedSausage = сырокопчёная колбаса
    .desc = Большая трубка сырокопчёной колбасы с острым соусом. Можно нарезать на ломтики пепперони.
ent-ADTFoodMeatSmokedSausageSlice = ломтик пепперони
    .desc = Ломтик острой сырокопчёной колбасы. Идеально подойдёт для пиццы пепперони.
