...
ent-ADTFoodCookieSpider = печенье паук
    .desc = Печенье в виде паука, который вряд ли вас укусит.. Если, конечно, вы не будете кусать его.
    .suffix = { "Хеллоуин" }
...
ent-ADTFoodCookieCaramelEar = слоёные ушки
    .desc = Печенье из слоёного теста, которое имеет форму, напоминающую сердце. 
    .suffix = День Святого Валентина

ent-ADTFoodCookieStrawberryHeart = клубничное печенье
    .desc = Песочное печенье с ягодной начинкой из клубники. Думаю, ваша вторая половинка будет в восторге от такого десерта.
    .suffix = День Святого Валентина
