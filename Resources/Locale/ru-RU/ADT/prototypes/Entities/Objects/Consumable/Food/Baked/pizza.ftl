...
ent-ADTFoodPizzaBolognese = пицца болоньезе
    .desc = Насыщенный вкус, прямо к вашему столу!


ent-ADTFoodPizzaBologneseSlice = кусок пиццы болоньезе
    .desc = Насыщенный вкус, прямо к вашему столу!

ent-ADTFoodPizzaCaesar = пицца цезарь
    .desc = Pizza pizza!


ent-ADTFoodPizzaCaesarSlice = кусок пиццы цезарь
    .desc = Pizza pizza!
...
ent-ADTFoodPizzaDiabloSlice = кусок пиццы дьябло
    .desc = Острая, но чертовски вкусная!

ent-ADTFoodPizzaFourcheese = пицца 4 сыра
    .desc = Когда вам всё ещё мало сыра на пицце.

ent-ADTFoodPizzaFourcheeseSlice = кусок пиццы 4 сыра
    .desc = Когда вам всё ещё мало сыра на пицце.

ent-ADTFoodPizzaMexican = мексиканская пицца
