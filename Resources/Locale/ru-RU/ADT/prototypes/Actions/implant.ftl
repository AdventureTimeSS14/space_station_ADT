...
ent-ActionToggleSandevistan = Сандевистан
    .desc = Переключить имплант Сандевистан. И помните: "Киберпсихи не становятся известными по тому, как они живут. Киберпсихи прославляются за то, как они умирают."
