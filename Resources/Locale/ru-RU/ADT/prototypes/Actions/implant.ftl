...
ent-ADTActionActivateStimulantsImplant = Стимуляторы
    .desc = Вводит вам в кровь порцию стимуляторов: снимает оглушение, поднимает на ноги и ускоряет.
adt-stimulants-implant-activated = По венам разливается жар, и усталость как рукой снимает.
