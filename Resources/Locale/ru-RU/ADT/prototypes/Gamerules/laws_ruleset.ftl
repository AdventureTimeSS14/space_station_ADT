...
new-laws-kind-3 = корги
new-laws-kind-4 = приматы
new-laws-kind-5 = кобольды
new-laws-kind-6 = слаймы
new-laws-kind-7 = неодушевлённые предметы

## Phrases used to describe the level of intelligence, though it doesn't actually affect anything.

new-laws-event-strength-1 = 1XX
new-laws-event-strength-2 = 2XX
new-laws-event-strength-3 = 3XX
new-laws-event-strength-4 = 310
new-laws-event-strength-5 = 4XX
new-laws-event-strength-6 = 5XX
new-laws-event-strength-7 = 507
new-laws-event-strength-8 = 6XX

## Announcement text

station-event-new-law-announcement =
    Опираясь на { $data }, мы приняли решение, что { $amount ->
        [1] { $kind1 }
        [2] { $kind1 } и { $kind2 }
        [3] { $kind1 }, { $kind2 }, и { $kind3 }
       *[other] { $kind1 }, { $kind2 }, { $kind3 }, и т.д.
    } является нарушением { $strength } порядка, а также должно быть пресечено службой безопасности.
