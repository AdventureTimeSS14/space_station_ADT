...
ent-YellowSlimeExtractLight = светлячок из жёлтого экстракта
    .desc = Кусочек жёлтого экстракта слайма, который светится сам по себе. Пригодится в тёмных местах.
ent-YellowSlimeExtractPowercell = батарея из жёлтого экстракта
    .desc = Батарея, выращенная из жёлтого экстракта слайма. Держит неплохой заряд и не задаёт лишних вопросов.
