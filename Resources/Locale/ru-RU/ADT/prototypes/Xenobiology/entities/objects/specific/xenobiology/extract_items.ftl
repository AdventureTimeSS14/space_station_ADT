...
ent-BlackSlimeExtractPowercell = батарея из чёрного экстракта
    .desc = Батарея, выращенная из чёрного экстракта слайма. Держит неплохой заряд и не задаёт лишних вопросов.
