...
ent-ADTXenobiologyCameraTagger = маркер камер ксенобиологии
    .desc = Помечает любую камеру и подключает её к сети ксенобиологии. Шпионьте за слаймами подальше от лаборатории, а то и за соседями!
