...
trait-deutsch-desc = Вы говорите как ein echter Deutscher!
...
trait-disproportionate-desc = Ваше тело непропорциоально, не позволяя носить комбинезоны. Взамен вы снабжены встроенными разъёмами под КПК, карманы а так же датчики.
