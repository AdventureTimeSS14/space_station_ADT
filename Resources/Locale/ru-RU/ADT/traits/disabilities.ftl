...
trait-soft-hands-desc = Ваши руки слишком слабы, что бы крепко держать что либо в обоих сразу.

trait-unadapted-to-space-name = Несовместимость с космосом
trait-unadapted-to-space-desc = Ваше тело не подготовлено к нагрузкам от космического вакуума из-за чего вы испытываете колоссальные перегрузки из-за него.
