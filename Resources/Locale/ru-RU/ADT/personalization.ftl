...
ent-ADTBibleContemplator = Том Созерцателя
    .desc = Кажется переплёт этой книги состоит из чьей-то чешуйчатой постоянно меняющейся кожи. Смотря на неё, вы четко осознаете, что не зависимо от того, кто вы, вы не можете противиться желанию оставить свою роспись в этой книге.
