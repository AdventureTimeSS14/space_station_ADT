...
ent-ADTClothingOuterHardsuitShizik = укреплённый костюм утерянного
    .desc = Костюм который повидал не первый день в безумной пустоши жизни, он похоже, был укреплён при помощи различных видов костей.
    .suffix = { "Спонсорское, Shizik" }

ent-ADTClothingHeadHelmetHardsuitShizik = шлем скафандра утерянного
    .desc = Это обычный шлем, без фонаря
    .suffix = { "Спонсорское, Shizik" }

ent-ADTClothingBackpackShizikBackpack = рюкзак утерянного
    .desc = Похоже, когда-то это был обычный рюкзак эксперта по утилизации. Сейчас это лишь напоминание прошлого.
    .suffix = { "Спонсорское, Shizik" }

ent-ADTClothingShoesBootsMagShizik = кровавые магнитные ботинки
    .desc = Самые обычные магнитные ботинки, покрытые кровью, грязью, и чёрт пойми чем ещё.
    .suffix = { "Спонсорское, Shizik" }


ent-ADTShizikSurvivalKnife = ржавый нож
    .desc = Этот нож сломан в нескольких местах, имеет кровавые ошмётки на нём, а также покрыт ржавчиной. Стоит быть осторожным с этим предметом.
    .suffix = { "Спонсорское, Shizik" }

ent-ADTShizikPicture = полароид
    .desc = Видимо, это потёртая временем фотография - полароид, на которой изображены несколько вульпканинов мужского пола, довольно похожих друг на друга внешним видом, эти двое смотрят в сторону фотографа. Один из них положил свою руку на плечо другого, настроение у фотографии счастливое, хоть что-то Вам подсказывает, что это счастье уже давно прошло.
    .suffix = { "Спонсорское, Shizik" }
