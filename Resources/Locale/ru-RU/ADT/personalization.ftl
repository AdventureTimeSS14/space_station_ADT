...
ent-ADTClothingNeckMantleRaven = потрёпанная парадная мантия офицера
    .desc = Перестрелка с еретиками, революционерами, с ядерными оперативниками и с членом экипажа, выгнавший с отдела, - обычный вторник для этого владельца. Эта мантия - сила клептомании и летальных последствий ГАММА кода.
