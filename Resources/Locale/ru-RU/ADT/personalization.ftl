...
ent-ADTWeaponProtoKineticPistolSirtalter = гипершасси КА
    .desc = Копирование цвета КА давно канувших в лету героев шахты. Какое-то оно слишком старое для обычной реплики... Есть следы грубого ремонта, плавления и трещины от ударов. Если присмотреться, можно заметить надпись "Пепел. Г. Грозы".
...
ent-ADTClothingHeadHelmetMinerSirtalter = череп молодого дрейка
    .desc = Шлем сделанный из черепа молодого пепельного дракона, его покрывают трещины, а какие-то части надколоты, что позволяет носить его без каких-либо неудобств. На рогах цветёт огнецет как символ удачи.
    .suffix = { "Именное, Sir_talter" }
