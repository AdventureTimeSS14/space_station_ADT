...
ent-ADTWeaponCutterBLAD = урановый резак
    .desc = Модифицированный некими умельцами шахтерский резак, который можно заправить еще и ураном. Режет хуже, но может стрелять еще и лазерным лучом.
    .suffix = { "Именное, BLAD" }
