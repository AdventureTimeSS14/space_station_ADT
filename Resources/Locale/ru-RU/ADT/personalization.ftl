...
ent-ADTClothingOuterHardsuitParamedLemon = модернизированный пустотный скафандр
    .desc = Модернизированный пустотный скафандр - та же модель, но улучшена и более приспособлена для комфортного ношения представителями всех видов и полов. Обладает отдельными зонами подогрева частей тела, так же оснащен массажерами конечностей, позволяя снижать усталость владельца. Дарит ощущение комфорта даже в холодном пустом космосе.
