...
ent-ADTClothingNeckRaven559SecOfficerMantle = потрёпанная парадная мантия офицера СБ 
    .desc = Перестрелка с еретиками, революционерами, с ядерными оперативниками и с членом экипажа, выгнавший с отдела, - обычный вторник для этого владельца. Эта мантия - сила клептомании и летальных последствий ГАММА кода. Пахнет кровью.
    .suffix = { "Именное, Raven559" }

ent-ADTClothingNeckRaven559OfficerBlueShieldMantle = потрёпанная парадная мантия Офицера "Синий Щит" 
    .desc = Перестрелка с еретиками, революционерами, с ядерными оперативниками и с членом экипажа, выгнавший с отдела, - обычный вторник для этого ОСЩ. Эта мантия - сила клептомании и летальных последствий после нападения на представителя командного состава.
    .suffix = { "Именное, Raven559" }
