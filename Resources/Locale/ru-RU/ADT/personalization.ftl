...
ent-ADTClothingUniformMelimaDress = чёрное платье с позолотой
    .desc = Чёрное платье из приятной, держащей форму ткани. Некоторые его части прошиты нитками золотого цвета, которые выделяются из-за матовости основного полотна. На подкладке иммется бирка "Saeros inc".
    .suffix = { "Спонсорское, Melima, Farrellka" }
