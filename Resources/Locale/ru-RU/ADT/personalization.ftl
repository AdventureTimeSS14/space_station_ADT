...
ent-ADTPlushieNinaKonogar = плюшевая Нина Коногар
    .desc = Прекрасная пушистая плюшевая игрушка капитана, выглядящая как помесь лисы и фелинида, с очень большим сверхпушистым хвостиком. На руке надето небольшое красное кольцо. Видно, что плюшевая игрушка была сделана на заказ. Пахнет каким-то приятным парфюмом.
