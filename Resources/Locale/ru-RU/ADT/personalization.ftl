...
ent-ADTClothingUniformTier3Shirt = футболка обладателя третьего уровня
    .desc = Черная футболка с большой римской цифрой "III" на спине и надписью спереди "Я заплатил 300 кредитов, получил пизды и эту футболку".
    .suffix = { "Спонсорское, Тест" }
