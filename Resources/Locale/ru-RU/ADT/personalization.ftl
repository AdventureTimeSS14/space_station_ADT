...
ent-ADTPlushieAreya = плюшевая Арея
    .desc = Плюшево-синяя милая аркана. От неё веет ягодным ароматом в перемешку с ароматом каких-то непонятных лекарств которые не разберут даже самые опытные химики... Сзади есть этикетка "Мамочка арканочка" 
