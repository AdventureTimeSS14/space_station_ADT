...
ent-BaseBlob = базовый блоб.
    .desc = { "" }
ent-NormalBlobTile = обычный тайл блоба
...
ent-ActionCreateBlobResource = Разместить ресурсный блоб (60)
...
ent-ActionCreateBlobNode = Разместить узел блоба (50)
...
ent-ActionCreateBlobbernaut = Произвести блобернаута (60)
...
ent-ActionDowngradeBlob = Понизить блоб
...
blob-carrier-role-rules = Вы антагонист. У вас есть 10 минут до превращения в блоб.
                        Используйте это время, чтобы найти безопасное место на станции. Помните, что сразу после превращения вы будете очень слабы.
blob-carrier-role-greeting = Вы носитель Блоба. Найдите укромное место на станции и превратитесь в Блоб. Превратите станцию в единую массу, а её обитателей — в своих слуг. Мы все — Блобы.
