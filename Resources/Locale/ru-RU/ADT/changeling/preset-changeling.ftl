...
changeling-armblade-retract-others = Клинок { $target } впитывается обратно в руку!
changeling-armblade-retract-self = Вы впитываете клинок обратно в свою руку.
changeling-armor-success-others = Тело { $target } набирает бронированную защитную массу!
changeling-armor-success-self = Ваше тело набирает защитную массу.
changeling-armor-retract-others = Броня { $target } отслаивается.
changeling-armor-retract-self = Ваша броня отслаивается.
changeling-regenerate-others-success = { $user } быстро излечивает все раны, издавая громкий, странный звук!
...
changeling-dna-stage-2-others = { $user } вытягивает жало!
changeling-dna-stage-3-self = Вы укалываете { $target } своим жалом!
changeling-dna-stage-3-others = { $user } укалывает { $target } жалом!
changeling-dna-success = Вы впитали ДНК { $target }.
changeling-dna-success-ling = Вы впитали ДНК { $target }. Это был другой генокрад! Вы набрали 5 очков эволюции.
changeling-dna-success-heretic = Вы впитали ДНК { $target }. Вы чувствуете в нём сильную паранормальную силу. Количество очков пополнено.
changeling-dna-success-brothrt = Вы впитали ДНК { $target }. За ним стояла сила братьев! Впитав её, вы получаете несколько очков эволюции
changeling-dna-fail-nohuman = { $target } не гуманоид.
changeling-dna-fail-notdead = { $target } не критическом состоянии или мёртв.
changeling-dna-interrupted = Поглощение ДНК { $target } было прервано.
changeling-dna-alreadyabsorbed = ДНК { $target } уже собраны!
changeling-dna-nodna = { $target } не имеет ДНК!
...
changeling-dna-sting-fail-alreadydna = У вас уже есть ДНК { $target }!
...
changeling-success-sting = Вы успешно ужалили { $target }!
...
changeling-armshield-success-others = Вокруг руки { $user } образуется массивный щит!
changeling-armshield-success-self = Ваша рука изгибается и мутирует, превращаясь в огромный массивный щит.
changeling-armshield-retract-others = Щит { $target } впитывается обратно в руку!
changeling-armshield-retract-self = Вы впитываете щит обратно в свою руку.
changeling-armshield-broke-others = Щит { $user } разорвался и впитался обратно!
changeling-armshield-broke-self = Ваш щит был пробит!
changeling-eggs-self-start = Вы начинаете откладывать личинки в { $target }.
changeling-eggs-self-success = Вы успешно оставили кладку в { $target }.
changeling-eggs-interrupted = Кладка была прервана!
changeling-egg-others = Личинки в теле { $user } начинают активно шевелиться и разрастаться!
...
changeling-armace-success-others = Кости и плоть руки { $user } преобразуются в огромный молот!
changeling-armace-success-self = Ваша рука изгибается и мутирует, превращаясь в огромный молот.
changeling-armace-retract-others = Молот { $target } впитывается обратно в руку!
...
changeling-digital-camo-desc = [color=white]{ $user } двигается неестественными рывками.[/color]
...
changeling-transform-sting-fail-already = ДНК { $target } слишком искажено!
