...
changeling-armblade-retract-others = Клинок { $user } впитывается обратно в руку!
changeling-armblade-retract-self = Вы впитываете клинок обратно в свою руку.
changeling-armor-success-others = Тело { $user } набирает бронированную защитную массу!
changeling-armor-success-self = Ваше тело набирает защитную массу.
changeling-armor-retract-others = Броня { $user } отслаивается.
...
changeling-armshield-retract-others = Щит { $user } впитывается обратно в руку!
