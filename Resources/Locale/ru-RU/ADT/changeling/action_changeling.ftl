...
action-extract-dna-sting-desc = Забирает пробу ДНК цели. Не информирует цель о том, что её ужалили. [color=#db03fc]Использует 15 химикатов.[/color]
...
action-adrenaline-desc = Ваше тело моментально вырабатывает химикаты, отключающие болевые рецепторы и останавливающие кровотечение. [color=#db03fc]Использует 5 химикатов.[/color]
...
action-mute-sting-desc = Ужальте кого-либо скрытым жалом и временно лишите его возможности говорить. [color=#db03fc]Использует 10 химикатов.[/color]

action-drug-sting = Галлюценогенное жало
action-drug-sting-desc = Введите кому-либо большое количество нетоксичного, но крайне мощного галлюценогена. Цель ни о чём не догадается, пока вокруг неё не начнёт происходить хаос. [color=#db03fc]Использует 5 химикатов.[/color]

action-fleshmend = Исцеление плоти
action-fleshmend-desc = Ваше тело моментально заживляет многие раны и ожоги. [color=#db03fc]Использует 15 химикатов.[/color]

action-lingmuscles = Напряжённые мышцы
action-lingmuscles-desc = Ваши мышцы ног начинают сокращаться, позволяя вам бегать с крайне высокой скоростью. [color=#db03fc]Использует 15 химикатов.[/color]
...
action-toggle-arm-shield-desc = Превращает одну из ваших свободных рук в щит, сделанный из костей и плоти. [color=#db03fc]Использует 15 химикатов.[/color]
...
action-biodegrade-desc = Синтезируйте крайне едкую кислоту и уничтожьте ей надетые на вас наручники. [color=#db03fc]Использует 5 химикатов.[/color]

action-resonant = Резонантный рёв
action-resonant-desc = Дезориентируйте окружающих вас не-генокрадов с помощью высокочастотного звука. [color=#db03fc]Использует 10 химикатов.[/color]
...
action-digi-camo-desc = Начните двигаться особым образом, предотвращая ваше обнаружение позитронными сенсорами. [color=#db03fc]Использует 25 химикатов.[/color]

action-bone-shard = Костяной сюрикен
action-bone-shard-desc = Создайте из своих костей сюрикен. [color=#db03fc]Использует 10 химикатов,[/color] [color=crimson]наносит 10 единиц урона.[/color]
