...
alert-level-blue-instructions = Главам станции обязательно нужно носить ID-карту в своём КПК. Также главам станции рекомендуется проявлять бдительность и сообщать службе безопасности o любой подозрительной активности.
