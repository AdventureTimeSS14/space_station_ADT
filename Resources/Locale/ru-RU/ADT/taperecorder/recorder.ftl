...
tape-recorder-empty = Кассетный проигрыватель пуст.
tape-recorder-recording = Кассетный проигрыватель в режиме [color=red]записи[/color].
tape-recorder-rewinding = Кассетный проигрыватель в режиме [color=yellow]отмотки[/color].
tape-recorder-locked = Невозможно извлечь, не остановив плёнку.
