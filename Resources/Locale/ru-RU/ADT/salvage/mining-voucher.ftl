...
ent-ADTBlueshieldVoucher = РВИ "Чертей"
    .desc = Радиальный Выборочный Интерфейс - Устройство для транспортировки новейших прототипов оружия прямо на место службы. Разработана NT специально для корпуса синих щитов.
    .suffix = { "ОСЩ" }

blueshield-voucher-saber-rev-name = набор с энергетическим мечом-револьвером
blueshield-voucher-saber-rev-description =
    Стандартное вооружение офицеров синего щита.
    Включает в себя энергетический меч-револьвер, а также 3 дополнительных для него батареии.
