...
mining-voucher-survival-description = Содержит РПС утилизатора, что позволяет переносить ещё больше вещей.
mining-voucher-minebot-name = Набор роботизированных раскопок
mining-voucher-minebot-description = Содержит маленького компаньона-копатьбота, который помогает вам хранить руду и охотиться на диких животных.
mining-voucher-spatio-name = Лёгкий скафандр утилизатора
mining-voucher-spatio-description = Легковесный скафандр, предназначенный для сложных технических работ в космосе.
mining-voucher-mining-armor-name = Костюм исследователя
mining-voucher-mining-armor-description = Не спасёт от давления, но хорошо защищает от фауны.
