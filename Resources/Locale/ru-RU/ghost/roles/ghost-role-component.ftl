...
ghost-role-component-default-rules =
    Вы [color=red]НЕ[/color] помните ничего из своей предыдущей жизни и не помните ничего из того, что узнали, будучи призраком, [color=red]ЕСЛИ[/color] администратор не сказал вам обратное.
    Вам [color=yellow]разрешается помнить[/color] знания об игре в целом, например, как готовить, как использовать предметы и т.д.
