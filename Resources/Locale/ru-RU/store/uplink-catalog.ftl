...
uplink-guerrilla-gloves-desc = Особая пара ударопрочных перчаток, устойчивых к электрическим разрядам, которая по умолчанию делает ваш захват жёстким, снижает замедление при удержании захвата и усложняет жертвам побег из него.
