...
uplink-pistol-viper-desc = Небольшой, легко скрываемый, но маломощный пистолет. Оснащён полностью автоматической ствольной коробкой. Использует патроны калибра 9х19 авто.
uplink-estoc-bundle-name = Марксманская винтовка Эсток
uplink-estoc-bundle-desc = Специальная снайперская винтовка, оснащенная оптическим прицелом для стрельбы на дальние дистанции. В комплекте два магазина для винтовки (6.5 мм ТСФ).
...
uplink-access-breaker-desc = Взломанный конфигуратор доступа, используется для принудительного открытия шлюзов и удаления требований по доступу у прочего снаряжения. Автоматически перезаряжается с течением времени.
...
uplink-contraband-lighter-name = Коробка с контрабандной зажигалкой
uplink-contraband-lighter-desc = Таинственный набор, в котором гарантированно будет зажигалка с брендом Syndicate. Не требует топлива.
