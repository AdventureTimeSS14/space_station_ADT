...
ADTuplink-ion-rifle-name = ионная винтовка
ADTuplink-ion-rifle-desc = Специализированная винтовка, стреляющая ионными зарядами, способными нарушать работу электронных устройств и создавать помехи для них. Повреждение распространяется на все части/компоненты. Огромная, но можно повесить на спину и имеет снайперский прицел.
