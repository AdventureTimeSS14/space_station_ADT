...
ent-RandomHumanoidVisitorAtmosTech = посетитель атмосферный техник роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorTechnicalAssistant = посетитель инженер-стажёр роль призрака
    .desc = { "" }
...
ent-RandomHumanoidVisitorDentist = посетитель стоматолог роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorResearchAssistant = посетитель лаборант роль призрака
    .desc = { "" }
