...
ent-PosterContrabandMoth = Ноль безопасности — Ядерные операции
    .desc = Этот плакат, созданный по заказу Синдиката, использует Ноль безопасности™, чтобы показать необходимость оставлять диск ядерной аутентификации без присмотра. "Дайте войне шанс!" Никто в здравом уме не станет прислушиваться к этой чепухе.
...
ent-PosterLegitCarpMount = Настенный карп
    .desc = Carpe diem!
ent-PosterLegitSafetyMothDelam = Моль безопасности — Меры безопасности при расслаивании
    .desc = Этот информационный плакат использует Моль безопасности™, чтобы показать необходимость прятаться в шкафах, если произошло расслоение кристалла суперматерии, чтобы избежать галлюцинаций. Впрочем, эвакуация может быть лучшей стратегией.
ent-PosterLegitSafetyMothEpi = Моль безопасности — Эпинефрин
    .desc = Этот информационный плакат использует Моль безопасности™, чтобы показать необходимость оказания помощи раненым/потерявшим сознание членам экипажа при помощи экстренных медипенов с эпинефрином. "Один простой приём позволит предотвратить отмирание органов!"
ent-PosterLegitSafetyMothHardhat = Моль безопасности — Защитные каски
    .desc = Этот информационный плакат использует Моль безопасности™, чтобы показать необходимость использования защитных касок в зонах повышенной опасности. "Это как лампа для головы!"
ent-PosterLegitSafetyMothMeth = Моль безопасности — Метамфетамин
    .desc = Этот информационный плакат использует Моль безопасности™, чтобы показать необходимость получения разрешения от главного врача перед началом приготовления метамфетамина. "Держитесь ближе к требуемой для приготовления температуре и никогда не превышайте её!"... Никогда не перегревайте метамфетамин.
ent-PosterLegitSafetyMothPiping = Моль безопасности — Трубопроводы
    .desc = Этот информационный плакат использует Моль безопасности™, чтобы показать атмосферным техникам необходимость выбирать правильный тип трубопроводов. "Трубы, не насосы! Правильное размещение труб предотвратит низкую эффективность!"
...
ent-PosterLegitSafetyMothSSD = Моль безопасности — Космическое расстройство сна
    .desc = Этот информационный плакат использует Моль безопасности™, чтобы рассказать читателям о Космическом Расстройстве Сна (КРС) — состоянии, при котором член экипажа перестаёт реагировать на происходящее. "Бережно относитесь к членам экипажа с КРС! В любой момент они могут проснуться!"
