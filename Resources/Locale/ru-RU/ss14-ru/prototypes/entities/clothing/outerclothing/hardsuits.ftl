...
ent-ClothingOuterHardsuitEngineeringWhite = продвинутый инженерный скафандр
...
ent-ClothingOuterHardsuitERTJanitor = скафандр ученого ОБР
    .desc = Защитный скафандр, используемый учеными отряда быстрого реагирования.
