...
ent-ClothingUniformJumpsuitERTJanitor = униформа ученого ОБР
    .desc = Специальный костюм, созданный для элитных ученых Центкома.
...
ent-ClothingUniformJumpsuitSeniorResearcher = комбинезон доцента
