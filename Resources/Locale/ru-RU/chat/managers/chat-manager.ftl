...
chat-manager-sender-announcement-wrap-message = [font size=14][bold]Объявление { $sender }:[/font][font size=12]
    { $message }[/bold][/font]
chat-manager-entity-say-wrap-message = [BubbleHeader][bold][Name]{ $entityName }[/Name][/bold][/BubbleHeader] { $verb }, "[BubbleContent][font="{ $fontType }" size={ $fontSize } ]{ $message }[/font][/BubbleContent]"
chat-manager-entity-say-bold-wrap-message = [BubbleHeader][bold][Name]{ $entityName }[/Name][/bold][/BubbleHeader] { $verb }, "[BubbleContent][font="{ $fontType }" size={ $fontSize }][bold]{ $message }[/bold][/font][/BubbleContent]"
chat-manager-entity-whisper-wrap-message = [font size=11][italic][BubbleHeader][Name]{ $entityName }[/Name][/BubbleHeader] шепчет,"[BubbleContent][BubbleContent][font="{ $fontType }" size={ $fontSize } ]{ $message }[/font][/BubbleContent]"[/italic][/font]
chat-manager-entity-whisper-unknown-wrap-message = [font size=11][italic][BubbleHeader]Кто-то[/BubbleHeader] шепчет, "[BubbleContent][font="{ $fontType }" size={ $fontSize } ]{ $message }[/font][/BubbleContent]"[/italic][/font]
