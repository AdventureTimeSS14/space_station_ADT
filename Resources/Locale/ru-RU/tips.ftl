...
tips-dataset-139 = Обязательно протирайте незаконные имплантанты с мылом или влажной тряпкой после их использования! Детективы могут сканировать использованные имплантанты на предмет наличия улик, но только в том случае, если они не были тщательно вытерты.
