...
humanoid-profile-editor-antag-roll-bonus-tooltip = Бонус к шансу выпадения роли за пропущенные раунды, в которых вы могли стать этим антагонистом, но не стали
humanoid-profile-editor-antag-roll-bonus-value = +{ $percent }%
