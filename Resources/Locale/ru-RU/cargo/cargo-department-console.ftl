...
ent-PaperAcquisitionSlipEngineering = квитанция о приобретении [Инженерный]
 .desc = Квитанция с данными заказа. Её можно передать в отдел снабжения для завершения заказа.

ent-PaperAcquisitionSlipService = квитанция о приобретении [Сервисный]
 .desc = Квитанция с данными заказа. Её можно передать в отдел снабжения для завершения заказа.

ent-PaperAcquisitionSlipSecurity = квитанция о приобретении [Служба безопасности]
 .desc = Квитанция с данными заказа. Её можно передать в отдел снабжения для завершения заказа.

ent-PaperAcquisitionSlipScience = квитанция о приобретении [Научный]
 .desc = Квитанция с данными заказа. Её можно передать в отдел снабжения для завершения заказа.

ent-PaperAcquisitionSlipMedical = квитанция о приобретении [Медицинский]
 .desc = Квитанция с данными заказа. Её можно передать в отдел снабжения для завершения заказа.