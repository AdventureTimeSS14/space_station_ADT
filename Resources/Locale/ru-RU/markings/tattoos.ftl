...
marking-TattooEyeshadowUpper-tattoo_eyeshadow_upper = Веки (Верхние)
marking-TattooEyeshadowUpper = Веки (Верхние)
# marking-TattooEyeshadowLower-tattoo_eyeshadow_lower = Веки (Нижние)
# marking-TattooEyeshadowLower = Веки (Нижние)
# marking-TattooEyeshadowLowerReptilian-tattoo_eyeshadow_lower_reptilian = Веки (Нижние)
# marking-TattooEyeshadowLowerReptilian = Веки (Нижние)
marking-TattooEyeshadowVoxSmall-tattoo_eyeshadow_small = Веки (Маленькие)
marking-TattooEyeshadowVoxSmall = Веки (Маленькие)
marking-TattooEyeshadowVoxMedium-tattoo_eyeshadow_medium = Веки (Средние)
marking-TattooEyeshadowVoxMedium = Веки (Средние)
marking-TattooEyeshadowVoxLarge-tattoo_eyeshadow_Large = Веки (Большие)
