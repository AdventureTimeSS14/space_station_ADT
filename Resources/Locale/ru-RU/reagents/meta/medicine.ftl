...
reagent-desc-saline = Смесь воды и крови с солью. Обычно используется для лечения обезвоживания или низкого содержания жидкости в крови, но так же помогает восстанавливать кровь в организме.
