...
reagent-desc-chlorine-trifluoride = Вы очень, ОЧЕНЬ не хотите, чтобы эта дрянь оказалась рядом с вами. Взрывается без стабилизирующего агента при температуре выше 373 кельвинов.
