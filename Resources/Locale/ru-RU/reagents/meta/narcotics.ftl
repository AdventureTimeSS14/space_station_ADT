...
reagent-desc-desoxyephedrine = Кустарный наркотик, сваренный на основе эфедрина. Имеет более выраженные побочные эффекты, включая периодические спазмы рук. Требует меньшей дозы для профилактики нарколепсии.
