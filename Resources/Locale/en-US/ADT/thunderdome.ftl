...
thunderdome-desc-akms = Assault rifle + 4 spare magazines
thunderdome-desc-python = AP-loaded revolver + 2 Speedloader
thunderdome-desc-inspector = Revolver + 3 speedloaders
thunderdome-desc-hristov = Anti-materiel sniper + 2 spare magazines
thunderdome-desc-esword = Energy sword + 3 hyperzine injectors
thunderdome-desc-capo = Capoeira manual + 2 injector pens
thunderdome-desc-mosin = Kardashev-Mosin + 3 spare magazines + ushanka + a vodka
