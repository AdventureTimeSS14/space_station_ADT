...
nano-chat-max-recipients = Max chats reached
...
nano-chat-new-title = Create new chat
nano-chat-number-label = User
nano-chat-name-label = Name
nano-chat-job-label = Job title
nano-chat-number-placeholder = Enter number
nano-chat-name-placeholder = Enter name
nano-chat-job-placeholder = Enter job title (optional)
...
nano-chat-group-create-title = Create group
...
nano-chat-group-member-list = Member list
