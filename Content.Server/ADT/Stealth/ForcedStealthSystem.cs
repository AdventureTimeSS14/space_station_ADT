...
using Content.Shared.ADT.Stealth;
using Robust.Shared.Prototypes;

namespace Content.Server.ADT.Stealth;
...
public sealed partial class ForcedStealthSystem : EntitySystem
{
    ...
    {
        statusEffect = null;
        return _status.TryAddStatusEffect(uid, ForcedStealth, out statusEffect, TimeSpan.FromSeconds(durationInSeconds));
    }
