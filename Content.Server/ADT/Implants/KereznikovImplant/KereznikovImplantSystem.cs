...
namespace Content.Server.ADT.Implants.KereznikovImplant;
...
public sealed class KereznikovImplantSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<KereznikovActiveComponent, ImplantEmpAffectedEvent>(OnEmp);
    ...
    private void OnEmp(Entity<KereznikovActiveComponent> ent, ref ImplantEmpAffectedEvent args)
    {
        _speed.RefreshMovementSpeedModifiers(ent.Owner);
        RemCompDeferred<KereznikovActiveComponent>(ent.Owner);
    }
