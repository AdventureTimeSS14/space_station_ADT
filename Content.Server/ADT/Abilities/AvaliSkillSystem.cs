...
namespace Content.Server.Abilities.Avali
{
    public sealed class AvaliSkillSystem : EntitySystem
    {
        ...
        {
            base.Initialize();
            SubscribeLocalEvent<AvaliSkillComponent, ComponentInit>(OnComponentInit);
            SubscribeLocalEvent<AvaliSkillComponent, InvisibleWallActionEvent>(OnInvisibleWall);
        }
        ...
        public override void Update(float frameTime)
        {
            ...
            var query = EntityQueryEnumerator<AvaliSkillComponent>();
        ...
        private void OnComponentInit(EntityUid uid, AvaliSkillComponent component, ComponentInit args)
        {
        ...
        /// </summary>
        private void OnInvisibleWall(EntityUid uid, AvaliSkillComponent component, InvisibleWallActionEvent args)
        {
