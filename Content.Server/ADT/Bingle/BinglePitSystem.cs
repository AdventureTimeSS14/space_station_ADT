...
using Content.Shared.ADT.Bingle;
...
using Content.Shared.StepTrigger.Systems;
using Content.Shared.Stunnable;
using Content.Server.ADT.Bingle;
...
namespace Content.Server.ADT.Bingle;
...
public sealed class BinglePitSystem : EntitySystem
{
    ...
    public void SpawnBingle(EntityUid uid, BinglePitComponent component)
    {
        ...
        var ascendSound = new SoundPathSpecifier("/Audio/ADT/Heretic/Ambience/Antag/Heretic/ascend_flesh.ogg");
    ...
    private void OnRoundEndTextAppend(RoundEndTextAppendEvent ev)
    {
        ...
        foreach (var ent in _pits)
        {
            ...
            var points = ent.Comp.BinglePoints + (ent.Comp.MinionsMade * ent.Comp.SpawnNewAt) * ent.Comp.Level;
