...
public sealed class SupermatterSpreaderSystem : EntitySystem
{
    ...
    private EntityQuery<EdgeSupermatterSpreaderComponent> _query;
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<EdgeSupermatterSpreaderComponent, EntityTerminatingEvent>(OnTerminating);
        SetupPrototypes();

        _query = GetEntityQuery<EdgeSupermatterSpreaderComponent>();
    }

    private void OnPrototypeReload(PrototypesReloadedEventArgs obj)
    {
        if (obj.WasModified<EdgeSupermatterSpreaderPrototype>())
            SetupPrototypes();
    }
    ...
    {
        _prototypeUpdates = [];
        foreach (var proto in _prototype.EnumeratePrototypes<EdgeSupermatterSpreaderPrototype>())
        {
    ...
    {
        EnsureComp<SupermatterSpreaderGridComponent>(ev.EntityUid);
    }

    private void OnTerminating(Entity<EdgeSupermatterSpreaderComponent> entity, ref EntityTerminatingEvent args)
    {
    ...
    public override void Update(float frameTime)
    {
        ...
        var spreadGrids = EntityQueryEnumerator<SupermatterSpreaderGridComponent>();
        ...
        var query = EntityQueryEnumerator<ActiveEdgeSupermatterSpreaderComponent>();
        var xforms = GetEntityQuery<TransformComponent>();
        var spreaderQuery = GetEntityQuery<EdgeSupermatterSpreaderComponent>();

        var spreaders = new List<(EntityUid Uid, ActiveEdgeSupermatterSpreaderComponent Comp)>(Count<ActiveEdgeSupermatterSpreaderComponent>());
