...
using Content.Server.ADT._Mono.AmmoLoader;
using Content.Server.ADT._Mono.FireControl;
...
using SpaceArtilleryComponent = Content.Server.ADT._Mono.SpaceArtillery.Components.SpaceArtilleryComponent;
