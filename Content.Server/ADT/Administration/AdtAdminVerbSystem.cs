...
//                         Act = () =>
//                         {
//                             if (!_siliconLawSystemADTT.TryGetMapOrGridCoordinates(args.Target, out var coords))
//                             {
...
//                         Act = () =>
//                         {
//                             if (!_siliconLawSystemADTT.TryGetMapOrGridCoordinates(args.User, out var coords))
//                             {
//                                 _popup.PopupEntity(Loc.GetString("admin-player-spawn-failed"), args.User, args.User);
//                                 return;
//                             }
