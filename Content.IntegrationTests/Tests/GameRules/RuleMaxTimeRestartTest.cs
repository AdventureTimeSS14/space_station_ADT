...
namespace Content.IntegrationTests.Tests.GameRules
{
    ...
    public sealed class RuleMaxTimeRestartTest
    {
        ...
        public async Task RestartTest()
        {
            ...
            // ADT-tweak: Don't assert zero components - previous tests may leave components
            ...
            EntityUid maxTimeRuleUid = EntityUid.Invalid;
            ...
            // ADT-tweak: Check that our specific rule exists, not total count
            ...
            // ADT-tweak: Verify our rule is still active, not total count
