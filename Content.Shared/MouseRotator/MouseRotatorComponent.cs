...
public sealed partial class MouseRotatorComponent : Component
{
    ...
    public Angle AngleTolerance = Angle.FromDegrees(2.5); // ADT-Tweak - 20.0 => 5.0
    ...
    /// </summary>
    [DataField, AutoNetworkedField]
    public double RotationSpeed = 540f;
    ...
    /// </summary>
    [DataField, AutoNetworkedField]
    public bool Simple4DirMode = false; // ADT-Tweak - false by default
}
