...
public sealed partial class BonkSystem : EntitySystem
{
    ...
    private bool TryStartBonk(EntityUid uid, EntityUid user, EntityUid climber, BonkableComponent? bonkableComponent = null)
    {
        ...
        if (!_cfg.GetCVar(CCVars.GameTableBonk))
        {
            ...
            if (TryRollClumsy(climber, bonkableComponent.BonkClumsyChance))
                return false;
        }
    ...
    private bool RollClumsy(ClumsyComponent component, float chance)
    {
        return component.Running && _random.Prob(chance);
    }

    private bool TryRollClumsy(EntityUid entity, float chance, ClumsyComponent? component = null)
    {
