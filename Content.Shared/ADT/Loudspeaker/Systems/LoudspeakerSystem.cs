using Content.Shared.ADT.Loudspeaker.Components;
...
using Content.Shared.ADT.Speaker.Components;

namespace Content.Shared.ADT.Loudspeaker.Systems;
...
public sealed class LoudSpeakerSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<LoudspeakerComponent, GetLoudspeakerDataEvent>(OnGetLoudspeakerData);        SubscribeLocalEvent<LoudspeakerComponent, ExaminedEvent>(OnExamined);
