...
public sealed partial class SlotMachineComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier BigWinSound = new SoundPathSpecifier("/Audio/ADT/Machines/SlotMachine/slotmachine_bigwin.ogg");

    [DataField]
    public SoundSpecifier JackPotWinSound = new SoundPathSpecifier("/Audio/ADT/Machines/SlotMachine/slotmachine_jackpotwin.ogg");

    [DataField]
    public SoundSpecifier GodPotWinSound = new SoundPathSpecifier("/Audio/ADT/Machines/SlotMachine/slotmachine_godpot.ogg");
    ...
    [DataField, AutoNetworkedField]
    public EntProtoId GodPotPrize = "WeaponShotgunHeavy"; // Это надо как-то отредактировать, ребята. Дробовик какой-то.
