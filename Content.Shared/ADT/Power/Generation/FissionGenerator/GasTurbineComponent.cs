...
// ADT: адаптировано под ADT (неймспейс).
...
public sealed partial class GasTurbineComponent : Component
{
    ...
    public ProtoId<SourcePortPrototype> SpeedHighPort = "GasTurbineSpeedHigh";

    /// <summary>
    /// The proto ID of the "Speed: Low" source port
    /// </summary>
    [DataField("speedLowPort")]
    public ProtoId<SourcePortPrototype> SpeedLowPort = "GasTurbineSpeedLow";
