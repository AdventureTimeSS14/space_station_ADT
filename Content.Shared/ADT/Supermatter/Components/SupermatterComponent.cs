...
public sealed partial class SupermatterComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier DistortSound = new SoundPathSpecifier("/Audio/ADT/Supermatter/charge.ogg");

    [DataField]
    public SoundSpecifier PullSound = new SoundPathSpecifier("/Audio/ADT/Supermatter/marauder.ogg");

    [DataField]
    public SoundSpecifier CalmLoopSound = new SoundPathSpecifier("/Audio/ADT/Supermatter/calm.ogg");

    [DataField]
    public SoundSpecifier DelamLoopSound = new SoundPathSpecifier("/Audio/ADT/Supermatter/delamming.ogg");
...
public static class SupermatterGasData
{
    public static readonly Dictionary<Gas, SupermatterGasFact> GasData = new()
    {
        ...
        { Gas.DexalinPlus,          new(0f, 0f, 0f, 0f) },
        { Gas.Omnizine,             new(0f, 0f, 0f, 0f) },
        { Gas.Inaprovaline,         new(0f, 0f, 0f, 0f) },
        { Gas.Diphenhydramine,      new(0f, 0f, 0f, 0f) },
        { Gas.Ichor,                new(0f, 0f, 0f, 0f) },
        { Gas.Phlogiston,           new(0f, 0f, 0f, 0f) },
        { Gas.PolytrinicAcid,       new(0f, 0f, 0f, 0f) },
        { Gas.SulfuricAcid,         new(0f, 0f, 0f, 0f) },
        { Gas.FluorosulfuricAcid,   new(0f, 0f, 0f, 0f) },
        { Gas.Bicaridine,           new(0f, 0f, 0f, 0f) },
        { Gas.Tricordrazine,        new(0f, 0f, 0f, 0f) },
        { Gas.Dylovene,             new(0f, 0f, 0f, 0f) },
        { Gas.Epinephrine,          new(0f, 0f, 0f, 0f) },
        { Gas.Dexalin,              new(0f, 0f, 0f, 0f) },
        { Gas.Kelotane,             new(0f, 0f, 0f, 0f) },
        { Gas.Charcoal,             new(0f, 0f, 0f, 0f) },
        { Gas.Iron,                 new(0f, 0f, 0f, 0f) },
        { Gas.Cryoxadone,           new(0f, 0f, 0f, 0f) },
        { Gas.ADTSilverSulfadiazine,new(0f, 0f, 0f, 0f) },
        { Gas.Toxin,                new(0f, 0f, 0f, 0f) },
        { Gas.Chlorine,             new(0f, 0f, 0f, 0f) },
        { Gas.Fluorine,             new(0f, 0f, 0f, 0f) },
        { Gas.Radium,               new(0f, 0f, 0f, 0f) },
        { Gas.Neurotoxin,           new(0f, 0f, 0f, 0f) },
        { Gas.Lexorin,              new(0f, 0f, 0f, 0f) },
        { Gas.Histamine,            new(0f, 0f, 0f, 0f) },
        { Gas.Mercury,              new(0f, 0f, 0f, 0f) },
        { Gas.WeldingFuel,          new(0f, 0f, 0f, 0f) },
        { Gas.Ethanol,              new(0f, 0f, 0f, 0f) }
    };
