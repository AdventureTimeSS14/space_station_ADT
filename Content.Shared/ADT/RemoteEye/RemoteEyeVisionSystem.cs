...
/// <summary>
/// Vision system for remote eye cameras.
/// Uses RemoteEyeCameraComponent instead of StationAiVisionComponent.
/// </summary>
public sealed class RemoteEyeVisionSystem : EntitySystem
{
    ...
    private readonly HashSet<Entity<RemoteEyeCameraComponent>> _seeds = new();
    ...
    {
        public required RemoteEyeVisionSystem System;
    ...
    private record struct ViewJob() : IParallelRobustJob
    {
        ...
        public Entity<MapGridComponent> Grid;
        public List<Entity<RemoteEyeCameraComponent>> Data = new();
