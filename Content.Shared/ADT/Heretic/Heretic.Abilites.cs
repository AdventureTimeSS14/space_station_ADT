...
public sealed partial class EventHereticRustConstruction : WorldTargetActionEvent
{
    ...
    [DataField]
    public SoundSpecifier? Sound = new SoundPathSpecifier("/Audio/ADT/Heretic/constructform.ogg");
...
public sealed partial class StarGazeEvent : InstantActionEvent // Giga lazor
{
    ...
    [DataField]
    public SoundSpecifier BeamStartSound = new SoundPathSpecifier("/Audio/ADT/Heretic/stargazer/beam_open.ogg");
}
...
public sealed partial class EventHereticCleave : WorldTargetActionEvent
{
    ...
    [DataField]
    public SoundSpecifier Sound = new SoundPathSpecifier("/Audio/ADT/Heretic/blood3.ogg");
}
