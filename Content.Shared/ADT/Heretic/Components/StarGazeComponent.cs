...
public sealed partial class StarGazeComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier BeamSound = new SoundPathSpecifier("/Audio/ADT/Heretic/stargazer/beam_loop_one.ogg");
    ...
    public SpriteSpecifier Beam1 =
        new SpriteSpecifier.Rsi(new ResPath("/Textures/ADT/Heretic/Effects/effects.rsi"), "beam1");

    [DataField]
    public SpriteSpecifier Beam2 =
        new SpriteSpecifier.Rsi(new ResPath("/Textures/ADT/Heretic/Effects/effects.rsi"), "beam2");

    [DataField]
    public SpriteSpecifier Beam3 =
        new SpriteSpecifier.Rsi(new ResPath("/Textures/ADT/Heretic/Effects/effects.rsi"), "beam3");

    [DataField]
    public SpriteSpecifier Start1 =
        new SpriteSpecifier.Rsi(new ResPath("/Textures/ADT/Heretic/Effects/effects96x96.rsi"), "start1");

    [DataField]
    public SpriteSpecifier End1 =
        new SpriteSpecifier.Rsi(new ResPath("/Textures/ADT/Heretic/Effects/effects.rsi"), "end1");

    [DataField]
    public SpriteSpecifier Start2 =
        new SpriteSpecifier.Rsi(new ResPath("/Textures/ADT/Heretic/Effects/effects96x96.rsi"), "start2");

    [DataField]
    public SpriteSpecifier End2 =
        new SpriteSpecifier.Rsi(new ResPath("/Textures/ADT/Heretic/Effects/effects.rsi"), "end2");

    [DataField]
    public SpriteSpecifier Start3 =
        new SpriteSpecifier.Rsi(new ResPath("/Textures/ADT/Heretic/Effects/effects96x96.rsi"), "start3");

    [DataField]
    public SpriteSpecifier End3 =
        new SpriteSpecifier.Rsi(new ResPath("/Textures/ADT/Heretic/Effects/effects.rsi"), "end3");
}
