...
public sealed partial class FireBlastedComponent : BaseSpriteOverlayComponent
{
    ...
    public SpriteSpecifier FireBlastBeamSprite =
        new SpriteSpecifier.Rsi(new ResPath("/Textures/ADT/Heretic/Effects/effects.rsi"), "solar_beam");

    public override Enum Key { get; set; } = FireBlastedKey.Key;

    [DataField]
    public override SpriteSpecifier? Sprite { get; set; } =
        new SpriteSpecifier.Rsi(new ResPath("ADT/Heretic/Effects/effects.rsi"), "blessed");
}
