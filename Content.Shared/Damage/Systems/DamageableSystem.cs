...
namespace Content.Shared.Damage
{
    public sealed class DamageableSystem : EntitySystem
    {
        ...
        public DamageSpecifier? TryChangeDamage(EntityUid? uid, DamageSpecifier damage, bool ignoreResistances = false,
            bool interruptsDoAfters = true, DamageableComponent? damageable = null, EntityUid? origin = null, EntityUid? tool = null, float armorPenetration = 0f) // ADT TWEAK // HELIX TWEAK
        {
            ...
            if (!ignoreResistances)
            {
                    ...
                    _prototypeManager.TryIndex<DamageModifierSetPrototype>(damageable.DamageModifierSetId, out var modifierSet))
                {
                    ...
                    damage = DamageSpecifier.ApplyModifierSet(damage, DamageSpecifier.PenetrateArmor(modifierSet, damage.ArmorPenetration)); // helix-edit
                }

                var ev = new DamageModifyEvent(damage, origin, tool); // ADT TWEAK
    ...
    public sealed class DamageModifyEvent : EntityEventArgs, IInventoryRelayEvent
    {
        ...
        public DamageModifyEvent(DamageSpecifier damage, EntityUid? origin = null, EntityUid? tool = null) // ADT TWEAK
        {
